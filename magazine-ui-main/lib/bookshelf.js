...
var currentDemo,
  ...
  samples = {
    ...
    'magazine7' : {'path' : 'samples/magazine7/'},
    'magazine8' : {'path' : 'samples/magazine8/'},
    'magazine9' : {'path' : 'samples/magazine9/'},
    'magazine10' : {'path' : 'samples/magazine10/'},
    'magazine11' : {'path' : 'samples/magazine11/'}
  },
  status = {
    'unloaded' : 0,
    'loading' : 1,
